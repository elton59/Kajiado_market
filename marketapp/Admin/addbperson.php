...
$mysqli = new mysqli($host,$username,$password,$database) or die($mysqli->error);
 $result=$mysqli->query("INSERT INTO businessperson(FIRSTNAME,LASTNAME,PHONE_NO,EMAIL,USERNAME,PASSWORD) VALUES('$fname','$lname','$fno','$email','$username')")or die($mysqli->error);
 if($result)
 {
