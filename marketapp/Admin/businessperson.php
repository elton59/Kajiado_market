...
<div class="content-wrapper">
  ...
  <div class="row">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-heading"><center>Business Person</center></div>
            ...
            <tr>
              <form method="post" action="searchbusinessperson.php?page=searchpayments">
              <td colspan="0">
              <input type="text"  placeholder="Search Field" name="search" class="form-control" required />
              </td>
              <td colspan="1">
 ...
 <div class="panel-body">
         <table id="example2" class="table table-bordered table-hover">
                      <thead>
                        <tr><th>BUSINESSPERSON_ID</th><th>FIRST_NAME</th><th>LAST_NAME</th><th>PHONE_NO</th><th>EMAIL</th><th>USERNAME</th><th>PASSWORD</th><th>STATUS</th><th>ACTION</th></tr>
                      </thead>
