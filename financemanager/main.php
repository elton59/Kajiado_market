                                ...
                                <div class="widget">
                                    <div class="widget-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                                         <div class="state">
                                                <h3>Pending stall  payment:
                                                 <?php
                                         $result=$mysqli->query("select *  from payment") or die(mysqli_error($mysqli));
               
                  while(list($PAYMENT_ID,$MPESA_CODE,$PAYMENT_DATE,$PAYMENT_TIME,$BUSSINESSPERSON_ID,$STATUS)=mysqli_fetch_array($result))
                  {
                    $sql="SELECT COUNT(PAYMENT_ID) AS total FROM payment where status='pending'";
                    ...
                    echo "<h3>$num_rows</h3>";
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="widget">
                                    <a href="taxpayment.php">
                                    <div class="widget-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="state">
                                                <h3>Pending tax payment:
                                                 <?php
                                         $result=$mysqli->query("select *  from taxpayment") or die(mysqli_error($mysqli));
               
                  while(list($PAYMENT_ID,$MPESA_CODE,$PAYMENT_DATE,$PAYMENT_TIME,$BUSSINESSPERSON_ID,$STATUS)=mysqli_fetch_array($result))
                  {
                    $sql="SELECT COUNT(PAYMENT_ID) AS total FROM taxpayment where status='pending'";
                    $result=$mysqli->query($sql);
                    $values=mysqli_fetch_assoc($result);
                    $num_rows=$values["total"];
                    echo "<h3>$num_rows</h3>";
