   ...
   if(isset($_POST['login']))
{
    ...
    $uname=$_POST['uname'];
    $upass=$_POST['upass'];
$sql = "SELECT * FROM finance WHERE username = '".$uname."' AND Password = '".$upass."' LIMIT 1";
...
<html class="no-js" lang="en">
    <head>
        ...
        <script src="../file/src/js/vendor/modernizr-2.8.3.min.js"></script>
    </head>
            ...
            <div class="container-fluid h-100">
                <div class="row flex-row h-100 bg-white">
                    <div class="col-xl-8 col-lg-6 col-md-5 p-0 d-md-block d-lg-block d-sm-none d-none">
                        <div class="lavalite-bg" style="background-image: url('src/img/downarrow.svg') ">
