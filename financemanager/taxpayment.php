    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
         <table id="example2" class="table table-responsive table-hover">
                      <thead>
                        <tr><th>PAYMENT_ID</th><th>MPESA_CODE</th><th>PAYMENT_DATE</th><th>PAYMENT_TIME</th><th>BUSSINESSPERSON_ID</th><th>AMOUNT</th><th>STATUS</th><th>ACTION</th></tr>
                      </thead>
                  ...
                  while($row=$result->fetch_assoc())
                  {
                    ...
                    <td>".$row['AMOUNT']."</td>
                    <td>".$row['STATUS']."</td>
                    <td> <a href='taxpayment.php?apid=$row[PAYMENT_ID]' class='btn btn-success'>approve</a>
