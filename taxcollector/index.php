   ...
   if(isset($_POST['login']))
{
    ...
    $upass=$_POST['upass'];
    $_SESSION['uname'];
$sql = "SELECT * FROM revenuecollectors WHERE USERNAME = '".$uname."' AND PASSWORD = '".$upass."' AND STATUS='approved' LIMIT 1";
$result = $mysqli->query($sql);
$row=$result->fetch_assoc();
$bpid=$row['REVENUECOLLECTOR_ID'];
$_SESSION['uname']=$row['USERNAME'];
$_SESSION['bpid']=$row['REVENUECOLLECTOR_ID'];
