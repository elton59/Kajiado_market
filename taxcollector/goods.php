...
<div class="content-wrapper">
  ...
  <div class="row">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-heading"><center>Goods</center></div>
           <div class="col-sm-6">
        ...
        <div class="panel-body">
         <table id="example2" class="table table-responsive table-hover">
                      <thead>
                        <tr><th>GOOD_ID</th><th>GOOD_NAME</th><th>QUANTIY</th><th>RA_ID</th></tr>
                      </thead>

                      <?php
                  $result=$mysqli->query("select * from goods")or die($mysqli->error);
...
<td><a href='greport.php' class='btn btn-danger'>Export to PDF</a></td>
