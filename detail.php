...
<div class="content-wrapper">
  ...
  <div class="row">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-heading"><center>My details</center></div>
           <div class="col-sm-6">
</div>
...
<th>BUSINESSPERSON_ID</th><th>FIRST_NAME</th><th>LAST_NAME</th></tr>
                      </thead>
                      
                      <?php
if(isset($_SESSION["uname"])){
                  $result=$mysqli->query("select * from stalls where FIRST_NAME='$_SESSION[uname]'")or die($mysqli->error);
  ...
  {
    $stall_id=$_GET['rsid'];
    $result = $mysqli->query("UPDATE stalls SET STATUS= 'occupied' WHERE STALL_ID = $stall_id") or die($mysqli->error);
