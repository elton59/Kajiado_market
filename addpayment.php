...
<div>
  ...
  <p style="color:black;text-align:center"><span style="color:green">BUSSINESS NO:</span>33456</p> 
   ...
   <p  style="color:red;text-align:center">* A stall costs ksh 3000* <br/>all rights reserved </p>
</div>
...
$result=$mysqli->query("INSERT INTO payment(MPESA_CODE,PAYMENT_DATE,PAYMENT_TIME,BUSINESSPERSON_ID,FIRST_NAME,LAST_NAME,MONTH,AMOUNT) VALUES('$mcode','$pdate','$ptime','$bpid1','$fname','$lname','$month','$amnt')")or die($mysqli->error);
 if($result)
 {
...
?>
                          ...
                          <option value="December">December</option>  
                                                ...
                                                <input type="int" class="form-control" id="amnt" placeholder="Businessperson_ID" name="amnt"  value="3000" required readonly>
