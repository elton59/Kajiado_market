...
<td><a href='revenuereport.php' class='btn btn-danger'>Export to PDF</a></td>
     ...
     if(isset($_GET['rjrcid']))
  {
    ...
    $result = $mysqli->query("UPDATE revenuecollectors SET STATUS= 'rejected' WHERE REVENUECOLECTOR_ID = $revenuecollector_id") or die($mysqli->error);
